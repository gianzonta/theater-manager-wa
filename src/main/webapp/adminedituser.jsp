...
<head>
  ...
  <title>Admin Edit Member - Ruzzante TMS</title>
          ...
          <div class="row">
            <div class="col-md-9 col-sm-9">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <form class="" action="" method="post" id="adminEditMemberForm">
                    ...
                    <div class="form-group">
                      <div class="col-md-6 offset-md-3">
                        ...
                        <button type="button" class="btn btn-danger"
                          onclick="delete_member(document.getElementById('username').value)">Delete Member</button>
                      </div>
                    </div>
                  </form>
