...
public final class DepartmentViewServlet extends AbstractDatabaseServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
            ...
            // forwards the control to the departmentdetail.jsp for display
            req.getRequestDispatcher("departmentdetail.jsp").forward(req, res);
